...
const SideBar = () => {
  return (
    <div className="absolute w-1/1 md:max-w-90 md:w-3/10 animate-[move_0.5s_1_linear] md:animate-[moveIt_2s_1_linear] duration-1000 md:static top-12 z-20 md:mx-4 h-125 md:block md:h-163 bg-[rgb(243,244,246)] rounded-none md:rounded-xl p-[25px] my-3 ">
      ...
      <Link to="/panel" className="w-1/1 mt-3 mb-5 md:mb-0 text-3xl md:text-base   md:w-29 cursor-pointer backgroundSize md:backgroundSize my-1 pr-9 md:pr-7 bg-[url(resources/Path29.png)] bg-no-repeat block bg-right bg-[10px 10px]">
        دوره های من
      </Link>
