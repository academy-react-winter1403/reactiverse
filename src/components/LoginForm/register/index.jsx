          ...
          >
              <Form className='regForm text-black p-5 rounded-2xl w-80 text-end'>
                ...
                <div className='p-1.5'>
                  ...
                  <Field className="w-3xs h-9 p-2.5 text-black mb-5 bg-gray-400 rounded-xl text-end outline-0" type="text" name="name" placeholder="نام"/>
                ...
                <button className="text-black w-36 h-10 block my-1.5 mx-auto rounded-2xl bg-blue-500" type='submit'>ادامه</button>
