...
const CardBody = ({title, desc, name, price, time}) => {
  return (
    <div className='bg-white w-[100%] h-[84%] relative bottom-[150px] rounded-3xl pt-[140px] z-[100] light'>
      ...
      <div className='flex justify-between p-[20px]'>
        <h3 className='w-[80px] h-[22px] rounded-xl bg-slate-400 text-center text-white'> {time} </h3>
        <h2 className='text-[#23496b] text-[19px]'>{price}</h2>
      </div>
    </div>
  )
}
