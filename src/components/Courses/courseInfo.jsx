...
const CourseInfo = ({TeacherName,Cost,Title,Description,Status,Technology,Level}) => {
  ...
  <div className='CourseInfo grid grid-cols-3 gap-6  w-[250px] h-[500px]'>

    <div className=' w-[230px] h-40 z-10 relative right-[9px]'><img className='rounded-3xl' src='./6.png'/></div>
    <div className='bg-gray-200 w-[250px] h-[330px]  mt-[100px] rounded-3xl relative left-[90px] pt-[60px] z-0 text-right light'>
      ...
      <div className='p-3 mt-5 flex justify-between w-full border-t-2 relative bottom-6'>
          <div className='w-[80px] h-[22px] rounded-xl bg-slate-400 text-center text-white ml-[50px] text-[14px]'>10:56:31</div>
          <div className='text-lg font-bold text-gray-800'>ت{Cost}</div>       
      </div>
    </div>
  </div>
  )
